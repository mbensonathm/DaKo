...
public class LoggingConnectionDecorator implements Connection {
    ...
    public void send(Serializable message) throws Exception {
        ...
        log.debug("Echo-Nachricht gesendet: " + echoPDU.getMessage());
    }
    ...
    public Serializable receive() throws Exception {
        ...
        log.debug("Echo-Nachricht empfangen: " + receivedPdu.getMessage());
        return receivedPdu;
    }
    ...
    public Serializable receive(int timeout) throws Exception {
        log.debug("Empfange Echo-Nachricht...");
        EchoPDU receivedPdu = (EchoPDU) wrappedClient.receive(timeout);
        log.debug("Echo-Nachricht empfangen: " + receivedPdu.getMessage());
        return receivedPdu;
    }
