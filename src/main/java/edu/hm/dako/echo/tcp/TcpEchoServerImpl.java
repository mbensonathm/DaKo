...
public class TcpEchoServerImpl implements EchoServer {

    private static Log log = LogFactory.getLog(TcpEchoServerImpl.class);

    private final ExecutorService executorService;

    private ServerSocket socket;

    public TcpEchoServerImpl(ExecutorService executorService, ServerSocket socket) {
